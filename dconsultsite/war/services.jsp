 ...
 "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
            ...
            <div id="tab_collection">
                ...
                <div id="new_left">
                    ...
                    <div class="box">
                      	<p>
                      	<strong>Ако не сте уверени, че Вашата фирма може да кандидатства за финансиране, моля попълнете <a id="contact_form_show" href="#">формуляра за връзка</a> с някой от нашите консултанти - те ще се свържат с Вас за безплатна консултация!</strong>	
                      	</p>
                      	<p>
