            ...
            <div id="tab_collection">
                ...
                <div id="new_left">
                    <div class="box">
                        <h2>Консултантски услуги</h2>
                      	<p>
                      	Услугите на <span>D Consulting</span> са фокусирани в подготовката, управлението и отчитането на проекти за получаване на безвъзмездна финансова помощ. Предлагаме Ви:	
                      	</p>
                    </div>
					<div class="box">
                        <ul>
                ...
                <div id="new_left">
					<div class="box">
                        ...
                        <p>Услугите на D Consulting са фокусирани в подготовката, управлението и отчитането на проекти за получаване на безвъзмездна финансова помощ. Предлагаме Ви:		
                        </p>
						<ul>
